...
class YoutubeClient {
    ...
    func taskForGETMethod(searchCategory: String, parameters: [String: String?], completionHandlerForGET: @escaping (_ result: AnyObject?, _ error: NSError?) -> Void) -> URLSessionDataTask {
