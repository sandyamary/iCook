...
class OptionsLauncher: NSObject, UICollectionViewDataSource, UICollectionViewDelegate, UICollectionViewDelegateFlowLayout {
    ...
    let optionItems: [Options] = {
        return [Options(name: "Add to Favorites"), Options(name: "Share"), Options(name: "Cancel")]
    }()
...
extension OptionsLauncher {
    ...
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        ...
        UIView.animate(withDuration: 0.5, delay: 0, usingSpringWithDamping: 1, initialSpringVelocity: 1, options: .curveEaseOut, animations: {
            ...
            if optionItem.optionName != "CANCEL" && optionItem.optionName == "Add to Favorites"  {
